...
categoryItems.forEach((item, index) => {
  item.addEventListener('click', () => {
    ...
    const leftPosition = itemPosition.left - menuPosition.left;
...
if (initialActiveItem) {
  ...
  const initialLeft = initialPosition.left - document.querySelector('.category-menu').getBoundingClientRect().left;
